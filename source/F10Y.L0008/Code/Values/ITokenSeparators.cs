...
namespace F10Y.L0008
{
        ...
        T000.ITokenSeparators
    {
        ...
        /// </summary>
        string For_DotnetPackName => Instances.Strings.Period;
        ...
        /// </summary>
        string For_TargetFrameworkMoniker => Instances.Strings.Dash;

        /// <summary>
        /// The token separator for version strings (example: "4.5.1").
        /// <para><inheritdoc cref="L0000.IStrings.Period" path="descendant::description"/></para>
        /// </summary>
        string For_Version => Instances.Strings.Period;
    }
}
